...
public class ClassUtilException extends RuntimeException {
	...
	private static final long serialVersionUID = 566142304277751408L;
	...
	public ClassUtilException(String message, Object... args) {
		super(message);
		this.values = new ExceptionValues(args);
	}

	public ClassUtilException(Throwable cause, String message, Object... args) {
		super(message, cause);
		this.values = new ExceptionValues(args);
	}
